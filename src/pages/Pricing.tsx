...
const plans = [
  {
    ...
    priceUsd: "~$580 USD",
    period: "/month",
    desc: "Essential security coverage for growing startups.",
    features: [
      "Infrastructure vulnerability scanning",
      "Web application security testing",
      "Basic code security analysis (SAST)",
      "Monthly security reports",
      "Email support & remediation guidance",
  ...
  },
  {
    ...
    priceUsd: "~$1,400 USD",
    period: "/month",
    desc: "Comprehensive security for scaling companies and institutions.",
    features: [
      "Everything in Core Protection",
      "Continuous monitoring & alerting",
      "Advanced SAST & dependency scanning",

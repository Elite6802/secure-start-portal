    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("is_deleted", models.BooleanField(default=False)),
                ("deleted_at", models.DateTimeField(blank=True, null=True)),
                ("role", models.CharField(choices=[("security_lead", "Security Lead"), ("developer", "Developer"), ("executive", "Executive")], default="security_lead", max_length=50)),
                ("is_primary", models.BooleanField(default=False)),
                ("organization", models.ForeignKey(on_delete=models.deletion.CASCADE, related_name="memberships", to="accounts.organization")),
